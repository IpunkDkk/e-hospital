...
@section('content')
    <div class="main-content">
                    ...
                    <div class="card">
                        <div class="card-header d-flex bd-highlight mb-3">
                            ...
                            <div class="p-2 bd-highlight">
                                <a type="button" class="btn btn-primary btn-sm flex-" href="{{ redirect()->getUrlGenerator()->previous() }}">Kembali</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tr>
                                    <th>Nik</th>
                                    <th>{{$user->profile->no_kk}}</th>
                                </tr>
                                <tr>
                                    <th>No Hp</th>
                                    <th>{{$user->profile->no_hp}}</th>

                                <tr>
                                    <th>Alamat</th>
                                    <th>{{$user->profile->alamat}}</th>
                                </tr>
                            </table>
                        </div>
                        <div class="card-header d-flex bd-highlight mb-3">
        ...
        <input type="hidden" id="table-user-url" value="{{route('rekam.data', $user->id)}}">
    </div>
@endsection
@push('js')
    ...
    <script>
        ...
        $('.btn-add').on('click', function (){
            $.ajax({
                method:'get',
                url:`{{ url('rekam-medis/pasien/rekam-medik/create/' . $user->id)}}`,
