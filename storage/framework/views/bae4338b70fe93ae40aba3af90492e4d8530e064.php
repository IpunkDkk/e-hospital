...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $('.btn-add').on('click', function (){
            $.ajax({
                method:'get',
                url:`<?php echo e(url('konfigurasi/permissions/create')); ?>`,
        ...
        $('#permission-table').on('click', '.action', function (){
            ...
            if (jenis == 'delete'){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            method:'delete',
                            url:`<?php echo e(url('konfigurasi/permissions')); ?>/${id}`,
                            headers: {
                                'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content')
                            },
                            success: function (ress) {
            ...
            $.ajax({
                method:'get',
                url:`<?php echo e(url('konfigurasi/permissions')); ?>/${id}/edit`,
                success: function (ress) {
                    $('#modalAction').find('.modal-dialog').html(ress)
                    modal.show();
                    store()
...
<?php echo $__env->make('panels.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\php\e-hospital\resources\views/konfigurasi/permissions.blade.php ENDPATH**/ ?>