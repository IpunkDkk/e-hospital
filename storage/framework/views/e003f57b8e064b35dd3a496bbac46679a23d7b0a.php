...
<?php $__env->startSection('content'); ?>
    <div class="main-content">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-row bd-highlight mb-3">
                                <div class="p-2 bd-highlight">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create rekam-medis/pasien')): ?>
        ...
        <input type="hidden" id="table-user-url" value="<?php echo e(route('pasien.data')); ?>">
    </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $('.btn-cari').on('click', function (){
            $.ajax({
                method:'get',
                url:`<?php echo e(url('rekam-medis/pasien/cari')); ?>`,
        ...
        $('.btn-add').on('click', function (){
            $.ajax({
                method:'get',
                url:`<?php echo e(url('rekam-medis/pasien/create')); ?>`,
                success: function (ress) {
                    $('#modalAction').find('.modal-dialog').html(ress).ready(function () {
                        Echo.channel('test-channel')
                            .listen('IotEvent', (e) => {
            ...
            if (jenis === 'delete') {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            method: 'delete',
                            url: `<?php echo e(url('rekam-medis/pasien/delete/')); ?>/${id}`,
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
                            success: function (ress) {
...
<?php echo $__env->make('panels.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\php\e-hospital\resources\views/rekam/pasien.blade.php ENDPATH**/ ?>